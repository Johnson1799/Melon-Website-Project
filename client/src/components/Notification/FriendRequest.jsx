...
const FriendRequest = (props) => {
    ...
    const acceptFriend = async(requestUserId) => {
        const url = `https://csci-3100-project.vercel.app/friends/request/accept/${userId}/${requestUserId}`;
        await fetch(url, {
            method: 'POST',
            headers: {
                Authorization: `Bearer ${token}`,
    ...
    const refuseFriend = async(requestUserId) => {
        const url = `https://csci-3100-project.vercel.app/friends/request/refuse/${userId}/${requestUserId}`;
        await fetch(url, {
            method: 'POST',
            headers: {
                Authorization: `Bearer ${token}`,
