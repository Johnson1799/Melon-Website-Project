...
const UserProfilePage = () => {
    ...
    const handleDataReceivedFromChild = async (editedData) => {
        ...
        if (editedData.userAvatarURL){
            const url = `http://csci-3100-project.vercel.app/users/user/update/avatar/${userId}`;
            const data = {
        ...
        /* Upload user post to Cloudinary database and create 'post' document in MongoDB */
            ...
            const url = `http://csci-3100-project.vercel.app/posts/create/${userId}`;
            const data = {
        ...
        if (editedData.postId){
            ...
            const url = `http://csci-3100-project.vercel.app/posts/update/${userId}`;
            await fetch(url, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
            ...
            const url = `http://csci-3100-project.vercel.app/users/user/${userId}/update`;
            await fetch(url, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
