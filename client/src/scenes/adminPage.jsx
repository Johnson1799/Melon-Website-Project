...
const AdminPage = () => {
    ...
    const getUsers = async() =>{
        setIsLoading(true);
        if (adminId){
            const url = `https://melon-web-project-server.vercel.app/admin/get/users/${adminId}`;
    ...
    const getPosts = async() => {
        setIsLoading(true);
        if (adminId){
            const url = `https://melon-web-project-server.vercel.app/admin/get/posts/${adminId}`;
    ...
    const deleteUser = async(userId) => {
        setIsLoading(true);
        if (adminId){
            const url = `https://melon-web-project-server.vercel.app/admin/delete/user/${adminId}/${userId}`;
